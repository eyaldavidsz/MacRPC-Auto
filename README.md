...
Built collaboratively with Gemini: I designed the architecture (plugin system, hot-reload, process detection) and used Gemini to accelerate implementation and documentation.
